...
CREATE TABLE IF NOT EXISTS amg_company_settings (
    id UUID DEFAULT uuid_generate_v4() PRIMARY KEY,
...
INSERT INTO amg_company_settings (company_name, logo_url, address, siret, email)
VALUES ('AMG Bijoux', NULL, '', '', '')
...
CREATE TRIGGER update_company_settings_updated_at
    BEFORE UPDATE ON amg_company_settings
    FOR EACH ROW
